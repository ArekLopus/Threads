...
public class PhaserTest2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		new PhaserTest2().testPhaser(phaser,2000);//phaser waiting for 2 parties
		new PhaserTest2().testPhaser(phaser,4000);//phaser waiting for 3 parties
		new PhaserTest2().testPhaser(phaser,6000);//phaser waiting for 4 parties
