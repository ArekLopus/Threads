...
public class Shop3Find2CFwithCustomExecutor {
	...
	public Shop3Find2CFwithCustomExecutor() throws InterruptedException, ExecutionException {
		...
		CompletableFuture<?>[] futures = findPricesStream("myPhone")
			...
			//or .toArray( CompletableFuture[]::new );
	...
	public static void main(String[] args) throws Exception {
		new Shop3Find2CFwithCustomExecutor();
	}
